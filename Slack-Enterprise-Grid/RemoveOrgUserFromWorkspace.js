...
function formatFromUserFromWorkspaceRequest(userId, workspaceId) {
    return {
        method: "POST",
...
module.exports = async (input, callback, error) => {
    ...
    try {
        ...
        const removeUserFromWorkspaceRequest = formatFromUserFromWorkspaceRequest(userId, workspaceId);
        callback(removeUserFromWorkspaceRequest);
    } catch (err) {
        errorCallback(`Error occurred: ${err}`);
    }
};